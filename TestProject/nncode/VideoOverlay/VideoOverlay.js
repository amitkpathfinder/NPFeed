...
const findNearestValue = (array, target) => {
  ...
  const handleProgress = (progress) => {
    ...
    const delta = progress.currentTime - (lastRecordedTime || 0);
    // if (delta > 0) {
    //   setlastRecordedTime(progress.currentTime);
    //   setStuckLoading(false);
    //   console.log('UP progress...........',progress.currentTime, lastRecordedTime);
    //   console.log('Up progress...........',stuckLoading);
    // }
    // else{
    //   setStuckLoading(true);
    //   setlastRecordedTime(progress.currentTime);
    //   console.log('Down 2 values progress...........',progress.currentTime, lastRecordedTime);
    //   console.log('Down progress...........',stuckLoading);
    // }

    if (delta > 0 && progress.currentTime > 1 && progress.playableDuration - progress.currentTime < 1) {
      setlastRecordedTime(progress.currentTime);
      setIsBuffering(true);
    } else {
