...
const SeekBar = ({
  ...
  const handleSeek = (seekTime) => {
    console.log('ssssssssssssssssssssssssssssssssssssXXXXXXXXXXXXXXXXXX');
    if (!videoRef?.current) {
    ...
    try {
      ...
      if (onSeek) {
        ...
        console.log('onSeek...............................',boundedSeekTime);
      }
  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderMove: (evt) => {
        ...
        //   handleSeekThrottled(boundedSeekTime);
        //   console.log('Running on Android 11 or higher-Saiyam\'s Device');
        // } else {
        //   handleSeek(boundedSeekTime);
        //   console.log('Running on an older Android version');
        // }
